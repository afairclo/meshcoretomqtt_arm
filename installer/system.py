...
def install_meshcore_decoder(install_dir: str, svc_user: str) -> bool:
    ...
    if platform.system() == "Darwin" or not svc_user:
        ...
        script = f"""
            ...
            . "$NVM_DIR/nvm.sh" && echo 'export NVM_NODEJS_ORG_MIRROR=https://unofficial-builds.nodejs.org/download/release' >> ~/.bashrc && echo 'export NVM_NODEJS_ORG_MIRROR=https://unofficial-builds.nodejs.org/download/release' >> ~/.bashrc && export NVM_NODEJS_ORG_MIRROR=https://unofficial-builds.nodejs.org/download/release && nvm install 22 && nvm use 22
